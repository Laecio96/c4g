        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="?page=add&action=server" method="post">
                    ...
                    <label for=""><span style="color: black;">Server IP/DOMÍNIO</span></label>
                    ...
                    <label for=""><span style="color: black;">SSL Port</span></label>
                    <input type="text" name="sslport" value="443" class="form-control">
...
<div class="modal fade" id="modalconfig" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
			...
			<?php
                $sql = $conn->query("SELECT * FROM configs WHERE valor='true'");
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="?page=edit&action=sms" method="post">
                                ...
                                <label for=""><span style="color: black;">N.º SMS</span></label>
                                <input type="text" name="nsms" class="form-control" value="<?= Functions::getConfig('nsms') ?>">
